...
const ace : AceAjax.Ace = require(
    // Go down to package.json
    "../../../" + 
...
// @ts-ignore
ace.config.set('basePath', // Go down to package.json
"../../../" + 
// Go down to trans++ main folder
"../../" +
// Enter into Ace folder
...
export class TranslationEngineOptionForm {
    protected options : {[category : string] : {
        lines : Array<TranslationEngineOptionFormLineDefinition>,
        orderBy? : (a : TranslationEngineOptionFormLineDefinition, b : TranslationEngineOptionFormLineDefinition) => number
    }} = {};
    protected categories : Array<string> = [];

    public addCategory (name : string, orderType? : (a : TranslationEngineOptionFormLineDefinition, b : TranslationEngineOptionFormLineDefinition) => number) {
